 ...
 * @return void
 */
#define QCHECK(expr, msg, args...)          \
  do {                                      \
    if (!(expr)) {                          \
      ELOG("QCHECK failed. " msg, ## args); \
      ASSERT(false);                        \
    }                                       \
  } while (false)
 ...
 * @return void
 */
#define QCHECK_EQ(lh, rh, fmt,  msg, args...)                 \
  do {                                                        \
    if (!((lh) == (rh))) {                                    \
      ELOG("QCHECK failed: "                                  \
               #lh " (" fmt ") == " #rh " (" fmt "). " msg,   \
 ...
 * @return void
 */
#define QCHECK_NE(lh, rh, fmt,  msg, args...)                 \
  do {                                                        \
    if (!((lh) != (rh))) {                                    \
      ELOG("QCHECK failed: "                                  \
               #lh " (" fmt ") != " #rh " (" fmt "). " msg,   \
 ...
 * @return void
 */
#define QCHECK_LT(lh, rh, fmt, msg, args...)                  \
  do {                                                        \
    if (!((lh) < (rh))) {                                     \
      ELOG("QCHECK failed: " fmt " < " fmt ". " msg,          \
           lh, rh, ## args);                                  \
      ASSERT(false);                                          \
    }                                                         \
  } while (false)
 ...
 * @return void
 */
#define QCHECK_LE(lh, rh, fmt, msg, args...)                  \
  do {                                                        \
    if (!((lh) <= (rh))) {                                    \
      ELOG("QCHECK failed: " fmt " <= " fmt ". " msg,         \
           lh, rh, ## args);                                  \
 ...
 * @return void
 */
#define QCHECK_GT(lh, rh, fmt, msg, args...)                  \
  do {                                                        \
    if (!((lh) > (rh))) {                                     \
      ELOG("QCHECK failed: " fmt " > " fmt ". " msg,          \
           lh, rh, ## args);                                  \
 ...
 * @return void
 */
#define QCHECK_GE(lh, rh, fmt, msg, args...)                  \
  do {                                                        \
    if (!((lh) >= (rh))) {                                    \
      ELOG("QCHECK failed: " fmt " >= " fmt ". " msg,         \
           lh, rh, ## args);                                  \
